...
//{
//	TEST_CLASS(CombinationGenerator_wReps_Tests)
//	{
//
//		BEGIN_TEST_CLASS_ATTRIBUTE(CombinationGenerator_wReps_Tests)
...
//		//	std::multiset<char> ExpectedResult = { 'A', 'C' };
//		//	CombinationGenerator_wReps<char> _Generator(Elements);
//
